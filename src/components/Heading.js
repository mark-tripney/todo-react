  ...
  return (
    <>
      ...
      <div className="delete-completed">
        <button className="delete-completed-btn" disabled={count===0 && todos===0} onClick={handleDeleteCompleted}>
          <svg
        ...
        <h2>{todos.length === 0 ? "Nothing to delete"
            : todos.length > 0 && count === todos.length ? "Nothing to Delete"
